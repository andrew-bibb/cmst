#  to add a translation the corresponding .ts file must be
#  enumerated below.  To modify a translation use QTLinguist
#  to operate on the .ts file.  Translations are built in
#  automcaically during the build process by the CONFIG += lrelease
#  and CONFIG+= embed_translations directives in cmstapp/cmst.pro
