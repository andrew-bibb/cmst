...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NetConnmanCounterInterface_t, stringdata) + ofs \
...
void NetConnmanCounterInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NetConnmanCounterInterface *_t = static_cast<NetConnmanCounterInterface *>(_o);
        switch (_id) {
...
const QMetaObject NetConnmanCounterInterface::staticMetaObject = {
    { &QDBusAbstractInterface::staticMetaObject, qt_meta_stringdata_NetConnmanCounterInterface.data,
      qt_meta_data_NetConnmanCounterInterface,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetConnmanCounterInterface.stringdata))
        return static_cast<void*>(const_cast< NetConnmanCounterInterface*>(this));
