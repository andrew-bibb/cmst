...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ConnmanAgent_t, stringdata) + ofs \
...
void ConnmanAgent::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ConnmanAgent *_t = static_cast<ConnmanAgent *>(_o);
        switch (_id) {
...
const QMetaObject ConnmanAgent::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ConnmanAgent.data,
      qt_meta_data_ConnmanAgent,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConnmanAgent.stringdata))
        return static_cast<void*>(const_cast< ConnmanAgent*>(this));
    if (!strcmp(_clname, "QDBusContext"))
        return static_cast< QDBusContext*>(const_cast< ConnmanAgent*>(this));
