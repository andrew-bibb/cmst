...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PropertiesEditor_t, stringdata) + ofs \
...
QT_MOC_LITERAL(6, 56, 19)
    ...
    "resetPage\0page\0resetAll\0updateConfiguration"
};
...
static const uint qt_meta_data_PropertiesEditor[] = {
 ...
 // slots: name, argc, parameters, tag, flags
       ...
       3,    0,   43,    2, 0x28 /* Private | MethodCloned */,
...
void PropertiesEditor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PropertiesEditor *_t = static_cast<PropertiesEditor *>(_o);
        switch (_id) {
...
const QMetaObject PropertiesEditor::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_PropertiesEditor.data,
      qt_meta_data_PropertiesEditor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PropertiesEditor.stringdata))
