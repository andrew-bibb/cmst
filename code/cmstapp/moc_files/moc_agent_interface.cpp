...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NetConnmanAgentInterface_t, stringdata) + ofs \
...
void NetConnmanAgentInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        NetConnmanAgentInterface *_t = static_cast<NetConnmanAgentInterface *>(_o);
        switch (_id) {
...
const QMetaObject NetConnmanAgentInterface::staticMetaObject = {
    { &QDBusAbstractInterface::staticMetaObject, qt_meta_stringdata_NetConnmanAgentInterface.data,
      qt_meta_data_NetConnmanAgentInterface,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_NetConnmanAgentInterface.stringdata))
        return static_cast<void*>(const_cast< NetConnmanAgentInterface*>(this));
