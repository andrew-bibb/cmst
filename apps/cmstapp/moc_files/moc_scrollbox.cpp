...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScrollBox_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScrollBox_t qt_meta_stringdata_ScrollBox = {
    {
QT_MOC_LITERAL(0, 0, 9), // "ScrollBox"
QT_MOC_LITERAL(1, 10, 14), // "setDisplayText"
...
void ScrollBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ScrollBox *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ScrollBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ScrollBox.data,
    qt_meta_data_ScrollBox,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ScrollBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ScrollBox.stringdata0))
